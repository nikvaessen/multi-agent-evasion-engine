...
public class MainFrame extends JFrame
{
    public MainFrame()
    {
        ...
        //agents.add(new MinimalPathAgent(map, floor, new Vector2D(20, 20), Direction.SOUTH, 5,
         //                        EngineConstants.VISION_RANGE, EngineConstants.VISION_ANGLE));

        agents.add(new MinimalPathAgent(map, floor, new Vector2D(300.0,50.0), Direction.NORTH, 5, EngineConstants.VISION_RANGE, EngineConstants.VISION_ANGLE));
        agents.add(new MinimalPathAgent(map, floor, new Vector2D(300.0,500.0), Direction.NORTH, 5, EngineConstants.VISION_RANGE, EngineConstants.VISION_ANGLE));
        ...
        agents.add(new DistanceAgent(map, floor, new Vector2D(50, 100), Direction.SOUTH, 5,
                EngineConstants.VISION_RANGE, EngineConstants.VISION_ANGLE));
